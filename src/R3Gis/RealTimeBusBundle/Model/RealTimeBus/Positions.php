...
class Positions {
	...
	if (!is_null($this->vehicleCode)){
            $whereVehicleCode = "    AND (vehicle_position_act.vehiclecode = '$this->vehicleCode' OR vehicle_position_act.vehiclecode = '$this->vehicleCode BZ' OR vehicle_position_act.vehiclecode = '$this->vehicleCode ME') order by gps_date desc";
	}
